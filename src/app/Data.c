...
/*	0x01,0x00,0x5E,0x31,0x00,0x04, 12,	0x0d,E2P_PrivateKey,						  0x80+WRITE,			1,NULL,NULL,*/
	...
	0x01,0x00,0x5e,0x31,0x00,0x07, Len1,0x42,E2P_ResetCrypoto,						0x80+WRITE,			1,NULL,NULL,
#if 0	
...
#endif
	0x01,0x00,0x01,0x08,0x00,0xFF, Len1,0x42,E2P_OrderPlusA,							0x80+WRITE,			1,Judge_P,NULL,  //正向计量标识
	0x01,0x00,0x02,0x08,0x00,0xFF, Len1,0x42,E2P_OrderDecA,								0x80+WRITE,			1,Judge_N,NULL,  //反向计量标识
	...
	0x01,0x00,0x60,0x32,0x01,0x01, Len10,0x0B,E2P_Manufactor_ID,					0x80+READ,1,NULL,NULL,
	...
	0x01,0x00,0x02,0x08,0x00,0xFF, Len8,0x69,CMon_EC_Pn0,									0x80+READ,			32770/*32768*/,NULL,NULL,
#else
	0x01,0x00,0x01,0x08,0x00,0xFF, Len8,0x69,CMon_EC_Pp0,									0x80+READ,			32768,NULL,GetP_Signature,
	
	0x01,0x00,0x02,0x08,0x00,0xFF, Len8,0x69,CMon_EC_Pn0,									0x80+READ,			32768,NULL,GetP_Signature,
#endif
