...
const SMLOBISTAB	SMLOBISTab[]=
{
	...
	0x01,0x00,0x60,0x01,0x00,0xff, 10,	0x0b,Server_ID,  									0x80+READ,			1,NULL,NULL,
...
#else
	0x01,0x00,0x10,0x07,0x00,0xFF, Len8,0x59,(uint32_t)&Para.Pt,				0x90+READ,			3,GetS,GetS_back,
#endif
