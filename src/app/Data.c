...
/*	0x01,0x00,0x5E,0x31,0x00,0x04, 12,	0x0d,E2P_PrivateKey,						  0x80+WRITE,			1,NULL,NULL,*/
	...
	0x01,0x00,0x60,0x05,0x00,0xFF, Len4,0x65,(uint32_t)&Para.meter_sts,  		RAM_TYPE+READ,			1,NULL,NULL,
	...
	0x01,0x00,0x00,0x02,0x00,0x02, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x03, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x04, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x05, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x06, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x07, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x08, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x09, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	
	0x01,0x00,0x00,0x02,0x00,0x0a, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x0b, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x0c, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x0d, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x0e, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	0x01,0x00,0x00,0x02,0x00,0x0f, 20,		0x81,(uint32_t)firmware_version,  				RAM_TYPE+READ+XPERMIT,			1,NULL,NULL,
	...
	0x01,0x00,0x01,0x08,0x00,0x60, Len8,0x69,(uint32_t)&Para.P0_day,	    RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x01,0x08,0x00,0x61, Len8,0x69,(uint32_t)&Para.P0_week,	    RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x01,0x08,0x00,0x62, Len8,0x69,(uint32_t)&Para.P0_month,	  RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x01,0x08,0x00,0x63, Len8,0x69,(uint32_t)&Para.P0_year,	    RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x01,0x08,0x00,0x64, Len8,0x69,(uint32_t)&Para.P0_last,	    RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x1F,0x07,0x00,0xFF, Len8,0x69,(uint32_t)&Para.Ia,	    		RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x33,0x07,0x00,0xFF, Len8,0x69,(uint32_t)&Para.Ib,	    		RAM_INTER_TYPE+READ,			3,NULL,NULL,
	0x01,0x00,0x47,0x07,0x00,0xFF, Len8,0x69,(uint32_t)&Para.Ic,	    		RAM_INTER_TYPE+READ,			3,NULL,NULL,
