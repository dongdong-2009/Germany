...
typedef struct {                                        
  __IO uint32_t CTL      ;             /* offset  0x0         AES ENC control register        */
  __IO uint32_t STA      ;             /* offset  0x4         AES ENC status register         */
...
typedef struct {                                                                       
  ...
  __IO uint32_t RESERVED[2];            /* offset  0x8~0xc     RESERVED address                */
  __IO uint32_t KEY2[8]    ;             /* offset  0x10~0x2c    AES DEC KEY register            */
...
//#define ECC_ENCRYPT                         ((AES_ENC_TypeDef *) AES_ENC_BASE       )
