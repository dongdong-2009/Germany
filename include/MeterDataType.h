...
*******************************************************************/
#define MeterDataTabNum	222//8		//电表数据项数
#define MeterRealTabNum	6			//电压电流等实时数据
#define MeterECTabNum	20

extern const METERDATATAB MeterDataTab[MeterDataTabNum];
extern const ID_OBIS RealTab[MeterRealTabNum];
extern const ID_OBIS ECTab[MeterECTabNum];
